...
<body>
	...
	<div class="text-center pt-5">
		<h1>Transfer My Money</h1>
	</div>
	
	<form action="trans" method="post" class="pt-3">
		<input type="hidden" name="nic" value="<%= nic %>">
		<div class="form-group">
			<label for="id">Your Account Number</label>
			<input type="text" class="form-control" name="sendid" value="<%= id %>" readonly>
			<small id="emailHelp" class="form-text text-muted">You can not account number</small>
		</div>
		<div class="form-group">
			<label for="id">Receiver Account Number</label>
			<input type="text" class="form-control" name="recid" required>
		</div>
		<div class="form-group">
			<label for="id">Transfer Amount</label>
			<input type="number" class="form-control" name="amount" required>
		</div>
		<br>
		<button type="submit" class="btn btn-primary btn-md btn-block btn-primary">Transfer Money</button>
	</form>
	<br>
	<br>
	<br>
