...
<body>
	...
	<form action="cardinsert" method="post" class="pt-3">
		...
		<div class="form-group">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="ctype" id="exampleRadios1" value="credit" checked>
		...
		<div class="form-group">
    		...
    		<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="des" required>Tell us, why  are you request card from us...</textarea>
  		</div>
		<br>		
		<button type="submit" class="btn btn-primary btn-md btn-block btn-primary">Request Card</button>
	</form>
	<br>
	<br>
