...
<body>
	...
	<div class="text-center pt-5">
		<h1>Send Loan Request To Manager</h1>
	</div>
	...
	<form action="loanreq" method="post" class="pt-3">
		<div class="form-group">
			<label for="id">Your Account Number</label>
			<input type="text" class="form-control" name="accNo" value="<%= id %>" readonly>
		...
		<div class="form-group">
			<label for="id">Your Monthly Salary</label>
			<input type="number" class="form-control" name="salary" required>
		</div>
		<div class="form-group">
			<label for="id">Required Loan Amount</label>
			<input type="number" class="form-control" name="amount" required>
		</div>
		<div class="form-group">
    		<label for="exampleFormControlTextarea1">Write Your Message</label>
    		<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description" placeholder="Tell your message to manager" required></textarea>
  		</div>
		<br>
		<button type="submit" class="btn btn-primary btn-md btn-block btn-primary">Send My Loan Request</button>
	</form>
	<br>
	<br>
