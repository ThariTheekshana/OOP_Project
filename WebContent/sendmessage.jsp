...
<body>
	...
	<form action="message" method="post" class="pt-3">
		...
		<div class="form-group">
    		...
    		<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="message" placeholder="Tell your message to manager" required></textarea>
  		</div>
  		<br>
  		<button type="submit" class="btn btn-primary btn-md btn-block btn-primary">Send Message</button>
	</form>
	<br>
	<br>
