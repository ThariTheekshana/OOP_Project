...
<body>
	...
	<div class="text-center pt-5">
		<h1>Update My Card Details</h1>
	</div>
	
	<form action="cardupdate" method="post" class="pt-3">
		...
		<button type="submit" class="btn btn-primary btn-md btn-block btn-primary">Update Card</button>
	</form>
	<br>
	<br>
