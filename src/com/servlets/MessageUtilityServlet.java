...
@WebServlet("/MessageUtilityServlet")
public class MessageUtilityServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    	...
	    	RequestDispatcher dis = request.getRequestDispatcher("allmessages.jsp");
